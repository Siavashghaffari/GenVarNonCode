...
elif (clin, cds, expression) == (True, True, False):
    case = "_NO_EXPRESSION"
elif (clin, cds, expression) == (True, False, True):
    case = "_NO_CDS"
...
#import 1000G and MGRB as control
CNV_1kG = Pd.read_csv("/hpf/largeprojects/tcagstor/users/sghaffari/lncRNA_Overlaps_IO/lncRNA_Overlapped_1000G_.tsv", sep='\t',low_memory=False)
...
MSSNG_parents = Pd.read_csv("/hpf/largeprojects/tcagstor/users/sghaffari/lncRNA_Overlaps_IO/lncRNA_Overlapped_MSSNG_parents.tsv", sep='\t',low_memory=False)
...
Overlap_1000G, C1000G_counter = Overlap_management(CNV_1000G, clin, cds, expression, CNV_size_cutoff)
...
Final_4.to_csv("Exons_probands+unaffected"+case+".tsv",sep="\t",index=False)
...
Final_15["all_1000G"] = 2504+4010

Final_15["male_probands"] = 2094+3533
Final_15["male_siblings"] = 928+105
Final_15["male_1000G"] = 1233+1756

Final_15.to_csv("lncRNA_Overlapping_CNVs"+case+".tsv",sep="\t",index=False)
...
# Final_15.to_csv("lncRNA_Overlapping_CNVs_with_pvalue"+case+".tsv",sep="\t",index=False)
